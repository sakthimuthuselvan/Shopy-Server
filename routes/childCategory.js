...
const { childCatgoryAdd, getChildCatgory, childCategoryUpdate, childCategoryDelete, parentCategoryData, getSpecificCategoryProduct } = require("../controllers/childCategoryFun");
...
app.post("/category/products", getSpecificCategoryProduct) //category/category/products
